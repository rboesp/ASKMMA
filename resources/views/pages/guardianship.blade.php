...
@section('content')
    ...
    @include('partials.minihero', [
        ...
        <section class="feedback py-16 bg-gray-100">
            ...
            <div class="flex flex-row flexbox flex-wrap">
                ...
                <div class="flex flex-row flex-wrap px-2">
                    <div class="w-full bg-white rounded p-4 lg:p-8">
        ...
        <section class="guardianship py-16 px-8 text-center text-ms lg:text-base lg:text-left">
            <div class="container mx-auto">
            <div class="lg:flex justify-between">
                <div class="lg:w-1/2">
                <div>
                    <p class="underline font-semibold">Who is MMA?</p>
                    <p class="lg:w-11/12 pt-2">
        ...
        <section class="guardianship py-16 text-center text-ms lg:text-base lg:text-left">
            ...
            <div class="flex flex-col lg:flex-row items-center lg:items-start w-full pt-12">
                ...
                <div class="flex flex-row lg:flex-col w-full flex-wrap lg:w-1/2 pt-6 lg:pt-2">
                    <div class="flex mt-4 lg:mt-0 flex-row lg:flex-col w-full items-center justify-center lg:justify-start">
                        <a href="#contactcta"
                        ><button
                            type="button"
                            class="
