        ...
        <div class="flex flex-row flexbox flex-wrap lg:flex-row flex-col-reverse">
            ...
            <div class="flex flex-col w-full lg:w-1/2 justify-around sm:items-center lg:justify-center lg:items-start">
                <div class="flex flex-row mt-6 w-full lg:w-3/4 lg:mt-0 ">
                    <p class="lg:text-base text-sm w-3/4 mx-auto lg:mx-0 text-center sm:text-center lg:text-left">
                        “Normally, I don't like Agents to come to my home. Because I live alone I rarely if ever will
                        let them in. But right away I could tell that Marc was very nice and I felt I could trust him
                        right away. I am very glad that I let him in and am so excited about my new plan. I referred him
