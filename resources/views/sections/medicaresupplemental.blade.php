	...
	<div class="flex flex-row flexbox flex-wrap">
		...
		<div class="card-right flex flex-col lg:w-1/2 lg:pl-8 py-6 px-8 justify-between">
			...
			<div class="flex flex-row">
				...
				<h3 class="text-3xl lg:text-4xl text-center lg:text-left font-black w-full leading-none lg:leading-normal">Medicare Supplemental</h3>
