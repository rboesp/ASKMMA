...
@section('content')
    ...
    <section class="container mx-auto flex flex-wrap text-base text-center px-3 md:px-0 lg:text-left">
        ...
        <div class="w-full mt-8">
            <p class="mt-4">
                Medicare Medicaid Advisors ("us", "we", or "our") operates the
                <a href="/" class="underline">www.askmma.com website</a> (hereinafter referred to as the "Service").
            </p>
            <p class="mt-4">
            ...
            <p class="mt-4">
                ...
                Conditions, accessible from www.askmma.com
            </p>
        </div>
