          ...
          <div class="w-full lg:w-4/5 flex flex-wrap">
            ...
            <div class="w-full mt-2 px-2 lg:m-0 lg:w-1/4">
              ...
              <span class="font-semibold text-mmadescription">
                <input v-model="form.title" class="w-full rounded border-mmablue border p-2"/>
              </span>
            </div>
            ...
            <div class="w-full mt-2 px-2 lg:m-0 lg:w-1/4">
              ...
              <span class="font-semibold text-mmadescription">
                <input v-model="form.location" class="w-full rounded border-mmablue border p-2"/>
              </span>
            </div>
            <div class="w-full mt-2 px-2 lg:m-0 lg:w-1/4">
            ...
            <div class="w-full mt-2 px-2 lg:m-0 lg:w-1/4">
              <span class="text-grey-dark">Salary + Extra</span><br>
              <span class="font-semibold text-mmadescription">
