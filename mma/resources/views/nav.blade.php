<nav id="header" class="flex items-center justify-between flex-wrap p-6 bg-white fixed w-full">
...
<div class="flex flex-row justify-between items-center">
  ...
  <div class="flex items-center flex-shrink-0 text-white mr-6 pl-8">
   	...
   	<img class="w-1/6 lg:w-1/3 pl-0 lg:pl-4 " src="images/mmausalogo.png">
